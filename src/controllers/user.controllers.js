...
const generateAccessAndRefreshToken = async (userId) => {
  try {
    ...
    //Todo later: apply check for user existance
...
const registerUser = asyncHandler(async (req, res) => {
  ...
  //Handling the user registeration
  try {
    //Creating new user
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //Todo Later: check for loggedInUser
...
//to generate new set of access tokens
